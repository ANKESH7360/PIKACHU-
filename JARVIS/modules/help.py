...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/pikachu_world"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/llDEVIL_WORLDII")
    ]
  ]
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴘᴀʜʟᴇ ᴊᴀʀᴠɪs ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 𖤍!! @Pikachu_XD_23", cache_time=0, alert=True)
